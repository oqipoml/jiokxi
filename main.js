function pjaxstart() {
    ...
    $(document).on("pjax:complete", function() {
        ...
        $("#tooltip").remove();
        try {
            if ("undefined" != typeof wenkmMedia) {
                return wenkmTips.show(document.title + " - 加载完成"),
                !0
            }
        } catch (b) {}
        return !1
...
function loadbg(d) {
    ...
    $(".colorful_loading_frame,.colorful_loading").css("display", "block"),
    "undefined" != typeof wenkmMedia && wenkmTips.show("第" + d + "张背景 - 加载中..."),
    c.onload = function() {
        jQuery(".bg-image").attr("src", c.src),
        RootCookies.SetCookie("myhk_bg", d, 30),
        bgid = d
    }
}
function grin(f) {
...
function get_emailinfo() {
    if ("" != jQuery("#email").val()) {
        if (-1 != jQuery("#email").val().indexOf("qq.com")) {
            ...
            setTimeout(function() {
                jQuery("#email .emailavatar").attr("src", "https://dn-qiniu-avatar.qbox.me/avatar.php?gravatar_id=" + hex_md5(jQuery("#email").val())) + "&size=32&d=monsterid&r=G&default=https://cdn.jsdelivr.net/gh/oqipoml/jiokxi/gravatar/default.jpg"
            }, 1000))
        } else {
            ...
            jQuery("#email .emailavatar").attr("src", "https://cdn.jsdelivr.net/gh/oqipoml/jiokxi/images/pjax_loading.gif"),
            setTimeout(function() {
                jQuery("#email .emailavatar").attr("src", "https://dn-qiniu-avatar.qbox.me/avatar.php?gravatar_id=" + hex_md5(jQuery("#email").val())) + "&size=32&d=identicon&r=G&default=https://cdn.jsdelivr.net/gh/oqipoml/jiokxi/gravatar/default.jpg"
            }, 1000))
        }
    } else {
        $("#email i").show(),
...
function pjaxdone() {
    ...
    $("#imgul>li").click(function() {
        ...
        setTimeout(function() {
            ...
            try {
                if ("undefined" != typeof wenkmMedia) {
                    return wenkmTips.show("第" + bgid + "张背景 - 设置完成"),
                    !0
                }
            } catch (b) {}
            return !1
    ...
    $(".fullscreen").click(function() {
        $(".fullscreen i").hasClass("fa fa-share") ? (RootCookies.SetCookie("myhk_sidebar", "no", 30),
        ...
        $(".fullscreen i").addClass("fa fa-reply")) : (RootCookies.SetCookie("myhk_sidebar", "no", -1),
...
function play(e, d) {
    try {
        if ("undefined" != typeof wenkmMedia && -1 == document.cookie.indexOf("myhk_player=") && songId + 1 != d) {
            return music(e, d),
            !0
        }
    } catch (f) {}
